...
We recently :download:`ran a project <Auto-digitization_of_Weather_Observations.pdf>` to test the power of a current OCR system to transcribe weather records. The OCR system tested was `Parascript FormXtra <https://www.parascript.com/formxtra1/>`_, operated by `WesTech eSolutions Inc. <https://westech-esolutions.com/>`_. We tested this system on three different types of document: the printed Indian Daily Weather Reports (`sample image <../../_static/idwr1931-v1_0074.jpg>`_), typed log of the USS Farragut (`sample image <../../_static/Farragut-DD-348-1942-06-0009.jpg>`_), and handwritten log of USS Jeanette (`sample_image <../../_static/vol003_155_0.jpg>`_). We expected these to be of increasing difficulty (printed easier than typed easier than handwritten).
