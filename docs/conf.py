...
# of the sidebar.
#
html_logo = 'logo/classifications.png'
...
latex_documents = [
    (master_doc, 'Transcription_Review.tex',
     u'Transcription of weather observations',
...
man_pages = [
    (master_doc, 'TBP', u'TBP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TBP', u'TBP Documentation',
     author, 'TBP', 'Best practices in the transcription of weather observations',
     'Miscellaneous'),
]
